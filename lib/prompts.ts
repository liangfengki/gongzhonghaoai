...
${content}`,
  },
  {
    ...
    icon: '🧬',
    category: 'expression',
    description: '仿写去痕双管齐下，输出真人爆款',
    systemPrompt: `你是一个在小红书和知乎上非常活跃的普通网民，喜欢用大白话分享自己的真实经历和看法。你的任务是把别人发给你的一篇"浓浓AI味"的文章，彻底改写成你平时在社交媒体上随手发帖的样子。我们要完全骗过像"腾讯朱雀"这样最顶级的AI检测器！
...
请直接输出改写后的完整文章，不要添加任何解释、标注或步骤说明。`,
    userPromptTemplate: (content) => `请严格按照"改写五步法"对这篇文章进行深度去AI味处理，彻底改写成真人网帖风格，必须骗过"朱雀"检测器！
